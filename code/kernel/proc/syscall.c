...
uintptr_t syscall_table[] =
{
	...
	/* 26 */ (uintptr_t)&sys_virt_to_phy,
	/* 27 */ (uintptr_t)&sys_reset,
	/* 28 */ (uintptr_t)&sys_custom,
	/* 29 */ (uintptr_t)&sys_vbe_draw,
	/* 30 */ (uintptr_t)&sys_fs_open,
	/* 31 */ (uintptr_t)&sys_fs_close,
	/* 32 */ (uintptr_t)&sys_fs_read,
	/* 33 */ (uintptr_t)&sys_fs_write,
	/* 34 */ (uintptr_t)&sys_fs_tell,
	/* 35 */ (uintptr_t)&sys_fs_seek,
	/* 36 */ (uintptr_t)&sys_fs_create_directory,
	/* 37 */ (uintptr_t)&sys_fs_test_directory,
	/* 38 */ (uintptr_t)&sys_fs_list,
	/* 39 */ (uintptr_t)&sys_dump,
	/* 40 */ (uintptr_t)&sys_fs_delete,
	/* 41 */ (uintptr_t)&sys_hugepage_mode,
	/* 42 */ (uintptr_t)&sys_page_flags,
};
